          ...
          <form onSubmit={(e) => onSubmit(e)}>
            ...
            >
                            ...
                            <input
                              ...
                              onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                                if (e.target.files && e.target.files.length > 0) {
                                  return setData((prev) => ({
                                    ...prev,
                                    [arrayFields[index]]: (e.target as HTMLInputElement).files
                                  }))
                                }
                              }}
                            ></input>
              ...
              <div className='pt-5 pb-2 bg-inherit'>
                {tryItOut && (
                  <button className='flex justify-center w-full py-1 my-5 font-bold text-white bg-blue-500' type='submit'>
                    Execute
                  </button>
                )}
              </div>
